...
public class Main extends Application {
    ...
    private TilePane menuFood = getProductCategoryMenu("主食");
    private TilePane menuDrink = getProductCategoryMenu("飲料");
    private TilePane menusnack = getProductCategoryMenu("小菜");
...
//以下都是方法模塊的定義-------------------------------------------------------------------
            ...
            if (product_dict.get(item_id).getCategory().equals(category)) {
                ...
                btn.setOnAction(new EventHandler<ActionEvent>() {
                    ...
                    public void handle(ActionEvent event) {
                        ...
                        //order_list.add(new Order("p-109", "新增的主食", 30, 1));
                        addToCart(item_id);
                        System.out.printf("%s %s\n", product_dict.get(item_id).getName(), product_dict.get(item_id).getDescription());
                    }
                });
            }
        }
    ...
    public TilePane getMenuSelectionContainer() {
        // 塞入菜單區塊 預設為主食類
        menuContainerPane.getChildren().add(menuFood);
        System.out.println("啟動App預設布置主食菜單");

        //定義"主食類"按鈕
        Button btnJuice = new Button();
        btnJuice.setText("主食類");
        ...
        //定義"小菜類"按鈕
        Button btnCoffee = new Button("小菜類");
    ...
    public TilePane getOrderOperationContainer() {
        ...
        //定義結帳按鈕
        // delete all data in display and order_list
    ...
    public void initializeOrderTable() {
        ...
        //table也可以這樣放入訂單
        //table.getItems().add(new Order("p-104", "奇異主食", 50, 2));
        ...
        order_item_qty.setOnEditCommit(new EventHandler<CellEditEvent>() {
            ...
            public void handle(CellEditEvent event) {
                ...
                OrderDetail target = (OrderDetail) event.getTableView().getItems().get(row_num); //取得該筆主食傳參考呼叫
    ...
    public void start(Stage stage) throws Exception {
        ...
        //取得菜單磁磚窗格並放入根容器
        // menuContainerPane.getChildren().add(menuFood); //可以在這裡將菜單窗格塞入飲料菜單
